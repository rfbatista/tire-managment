    ...
    >
      <View>
        <VStack space={2}>
          ...
          />
          <MenuCard
            title='Modelo de Pneu'
            subtitle='Cadastrar informações de novos modelos de Pneu'
            imageUrl='https://hvs88dzl.media.zestyio.com/TireBuying_Section1_02.jpg'
            buttonTitle='Cadastrar'
            onClick={() => navigation.navigate('RegisterModel')}
          />
        </VStack>
      </View>
    </ScrollView>
